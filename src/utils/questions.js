...
const questions = [
  {
    id: 0,
    question: '¿Cómo acceder al contenido gratuito?',
    answer: (
      <div>
        ...
        Consulta lo que ofrecemos en cada metodología dando click en
        el menú superior <b>“Oferta académica”</b>
      </div>
    ),
  },
  {
    id: 1,
    question: '¿Cómo puedo apoyar a Libel Up?',
    answer: (
      <div>
        ...
        <p>
          Y si eres un artista apasionado por la enseñanza, también
          puedes donar cursos para la comunidad.
        </p>
      </div>
    ),
  },
      ...
      <div>
        <ol style={{ paddingLeft: 30 }}>
          <li>
            ...
            si no lo has hecho, contacta a la asesora que te acompañó
            durante el proceso de pago para que te envíe el
            formulario.
          </li>
          <li>
        ...
        <b>NOTA:</b> Recuerda que los accesos se envían 2 días antes
        de iniciar el curso/máster
      </div>
    ),
  },
  {
    id: 3,
    question:
      '¿Cada cuánto habrá cursos gratuitos?',
    answer: (
      <div>
        ...
        solicitud puede tardar entre 2 y 3 días hábiles. Agradecemos
        que seas paciente.
      </div>
    ),
  },
  {
    id: 4,
    question: '¿Qué enseñarán en los cursos gratuitos?',
    answer: (
      <div>
  ...
  },
  {
    id: 5,
    question:
      '¿Puedo solicitar devolución de mi donación?',
    answer: (
      <div>
        Las únicas licencias que tenemos disponibles para entregar y/o
        vender son las licencias de Reallusion (Character Creator,
        Iclone, Headshot…) y licencias de ZBrush. Más información en
        el menú, sección Licencias.
      </div>
    ),
  },
  {
    id: 6,
    question:
      '¿Cuál es la diferencia entre un máster y un curso en vivo?',
    answer: (
      <div>
        Los másteres incluyen diferentes temas, diferentes softwares,
        cursos complementarios en vídeo y un nivel
        intermedio-avanzado, los cursos se centran en un único tema y
        software con un nivel básico-intermedio.
      </div>
    ),
  },
  {
    ...
    answer: (
      <div>
        ...
        tarjeta débito/crédito, Efecty, y Baloto), PayPal, Western
        Union y Tarjeta crédito. Recuerda que PayPal no está
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        abiertos en los siguientes horarios: Lunes a viernes: 8:00 am
        a 5:00 pm, hora Colombia Sábado: 8:00 am a 11:00 am, hora
        Colombia Domingos y festivos (calendario colombiano) no hay
        atención Nuestro <b>canal de soporte</b> está abierto en los
        siguientes horarios: Lunes a viernes: 9:00 am a 1:00 pm, hora
        Colombia Sábados, domingos y festivos (calendario colombiano)
        no hay atención. Los <b>canales de venta</b> generalmente
        tienen un horario extendido del horario administrativo, sin
        embargo, la respuesta podría tardar un poco más si escribes
        después de las 6 pm, los sábados en la tarde o los domingos
        (tiempo de Colombia). Las{' '}
        <b>asesorías a estudiantes o aspirantes</b> pueden agendarse
